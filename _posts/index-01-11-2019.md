...
![c brennan moji-man](https://avatars2.githubusercontent.com/u/50818414?s=400&u=a6291a045d54cf685ddf9e3f3c6e71eedd5b2c52&v=4)
...
- Explore the underlying issues affecting the workforce; 
    ...
    - Address all associate : 
        ...
        - Act as voice of dock to regional & executive management team. 
            - Advocate for 
                1. Adequate equipment.
                2. Long-term incentive 
                    - Career path,
                3. Workflow process 
                4. Continuous improvemnt.
1. Author and co-collaborator to:   
    -__20%__ productivity enhancement.  
    -  _40%__ gain in delivery before exception metric.  
    - Permanent cancellation of __4__ line-haul scchedules. 
        1. Implement dynamic loading. 
        2. Institute proper planning process to zone supervisors.
    - Shave __6__ local routes, and  
        1. Result :
            - __2%__ overall on-time service improvement.  
---    
...
1. Regional travel providing terminal ops team  
    ...
    - Organizational Dynamics 
        ...
        3. Complete buy-in & total process overhaul.
...
4. Forge genuine relationship with drivers of responsibility through :   
...
9. Push to improve regional perspective  
    - Defining benchmark measure at 98.6%  while progressively improving to a 99.4% SOP.  
        ...
        4. Pro-active management of day-to-day variables.
        5. Perfecting the  :
            - Planning,  
            - Prediction forecasting, 
                1. Daily controllable areas;  
        6. Produce an environment conducive to excellence that executes consistently.  
...
6. Verify all service freight has been  
    - Picked up,  
    - Properly manifested with
        1. Supporting documentation.
    - Handled properly in loading,
    - Braced and blocked for riding.
7. Establish next day operations game plan by reviewing inbound tonnage levels.  
8. Ensure zone has the equipment to load on and reconcile equipment number to match status in software.  
9. Create a fluid transition and encourage cross-function collaboration with inbound operation team by 
    - Reconcilation of nightly reports & 
        1. Due service freight in place to succeed.
    - Monitor and  
    - Audit national account shipment status,  
...
`Business Administration` | `Cross-Functional Collaboration` | `Experience in facilitation of multi-disciplinary teams`
:---|:---:|---:
