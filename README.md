...
=======
13 | Freight Handler | Roadway Express Inc | Atlanta, GA | Aug 2002 | Feb 2003 | Y | Out-of-Business<br>
...
`33 Gilmer Street Atlanta, GA 30315` `Faculty Scholar 2004` `Dean's List 2005` `Class of 2006`
...
=======
### Real - Time Real - Life Work Experience
...
7. Invitation & short-list offers
 - Learn Launch
    - Hatch Pitch,
    - Gener8tor.
8. Chief Executive of dribbble; Zack Onisko, drafts to platform; as [non-designer and like-minded growth - hack](https://dribbble.com/C-Brennan-Poole/about).
9. Achieve [Popular on Pinterest](https://www.pinterest.com/wtihWindllc) status with
...
> For the first time in over 7 years (non-fault accident occured in / around Cedarotn, WE)
...
1. Design, Develop, and implement dynamic daily operational strategy helping ensure 98.6% on-time service and forst errk fist
    - Consisting of approximately 650,000 to 1.5 million pounds of overnight due-service origin freight, and
    - Approximately 4 to 6 million pounds in-bound break tonnage due-in nightly
    - Associate shift composition of
